...
/// <summary>
/// Public class for store the Ability Types for use in the game (Used for example in the Abilities)
/// Prefered use constants values instead of the standard enum values because it is more scalable.
/// </summary>
